...
const RecipeFilters: React.FC<RecipeFiltersProps> = React.memo(
  ({ filters, onFilterChange }) => {
    ...
    const handleFoundStatusChange = useCallback(
      (value: string) => {
    ...
    return (
      <Flex direction={{ initial: 'column', sm: 'row' }} gap="4" wrap="wrap">
        <Box className="min-w-[150px] flex-1">
          <Select.Root
            value={filters.type || 'default'}
            onValueChange={(value) =>
              handleTypeChange(value === 'default' ? '' : value)
            }
          >
            <Select.Trigger
            ...
            <Select.Content>
              ...
              <Select.Item value="Found Ingredient">
                Found Ingredient
              </Select.Item>
            </Select.Content>
          </Select.Root>
        ...
        <Box className="min-w-[150px] flex-1">
          <Select.Root
            ...
            onValueChange={(value) =>
              handleRarityChange(value === 'default' ? '' : value)
            }
          >
            <Select.Trigger
        ...
        <Box className="min-w-[150px] flex-1">
          <Select.Root
            ...
            onValueChange={(value) =>
              handleFoundStatusChange(value === 'default' ? '' : value)
            }
          >
            <Select.Trigger
        ...
        <Box className="min-w-[150px] flex-1">
          <Select.Root
            ...
            onValueChange={(value) =>
              handleLocationTypeChange(value === 'default' ? '' : value)
            }
          >
            <Select.Trigger
